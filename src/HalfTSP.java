...
public class HalfTSP {
    ...
    /**
     * The aim of this project is to find the best solution as much as possible to Half TSP which is basically a hard
     * NP problem in a reasonable time.
     */


    public static void main(String[] args) {
        //In this function take input file’s name, then read the cities in the input file and call
